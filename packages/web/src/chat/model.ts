...
export interface NoteBlock { id: string; type: "note"; kind: string; text: string }
...
export interface NoteRender { kind: "note"; blockId: string; noteKind: string; text: string }
